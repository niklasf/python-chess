...
NAGS = {
    ...
    # "?!"
    "6": """<g id="inaccuracy">
                <path class="icon-background" fill="#f1a500" d="M 7.506 0 C 1.737 0 -1.869 6.25 1.015 11.25 C 3.9 16.25 11.111 16.25 13.996 11.25 C 14.654 10.11 15 8.817 15 7.5 C 15 3.358 11.644 0 7.506 0 Z"></path>
