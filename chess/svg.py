...
NAGS = {
    ...
    # "N"
    "146": """<g id="novelty">
                <path class="icon-background" fill="black" d="M 7.506 0 C 1.737 0 -1.869 6.25 1.015 11.25 C 3.9 16.25 11.111 16.25 13.996 11.25 C 14.654 10.11 15 8.817 15 7.5 C 15 3.358 11.644 0 7.506 0 Z"></path>
                <path class="icon-component" fill="white" d="M 3.805 3.116 L 3.805 12.077 L 5.684 12.077 L 5.684 6.701 L 9.438 12.077 L 11.316 12.077 L 11.316 3.116 L 9.438 3.116 L 9.438 8.492 L 5.684 3.116 L 3.805 3.116 Z"></path>
              </g>"""
