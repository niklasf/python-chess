...
NAGS = {
    ...
    # "N"
    "146": """<g id="novelty">
                <path class="icon-background" fill="#990F02" d="M 7.506 0 C 1.737 0 -1.869 6.25 1.015 11.25 C 3.9 16.25 11.111 16.25 13.996 11.25 C 14.654 10.11 15 8.817 15 7.5 C 15 3.358 11.644 0 7.506 0 Z"></path>
                <path class="icon-component" fill="white" d="M 4.053 3.554 L 4.053 11.833 L 5.815 11.833 L 5.815 6.866 L 9.335 11.833 L 11.096 11.833 L 11.096 3.554 L 9.335 3.554 L 9.335 8.521 L 5.815 3.554 L 4.053 3.554 Z" style=""></path>
              </g>"""
