...
from chess._engine import MockProcess
from chess._engine import PopenProcess
from chess._engine import SpurProcess
    ...
    def _info(self, arg):
        ...
        for token in arg.split(" "):
            if current_parameter == "string":
                ...
                pass
            elif token in ["depth", "seldepth", "time", "nodes", "pv",
                           "multipv", "score", "currmove", "currmovenumber",
                           "hashfull", "nps", "tbhits", "cpuload",
                           "refutation", "currline", "ebf", "string"]:
                end_of_parameter()
                current_parameter = token
